...
export const metadata = {
  title: "Indexes | Stocks Screener",
  description: "Track broad market index ETFs and benchmark performance on Stocks Screener.",
  alternates: {
    canonical: "/markets/indexes"
  }
};
...
export default async function IndexesPage() {
  const section = getMarketSectionBySlug("indexes");
