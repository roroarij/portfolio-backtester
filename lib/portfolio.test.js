    ...
    assert.deepEqual(result.series, [
      {
        ...
        value: 10,
        holdings: [
          { symbol: "OLD", quantity: 1, close: 10, value: 10 },
          { symbol: "NEW", quantity: 2, close: 0, value: 0 }
        ]
      },
      {
        date: "2020-01-03",
        value: 11,
        holdings: [
          { symbol: "OLD", quantity: 1, close: 11, value: 11 },
          { symbol: "NEW", quantity: 2, close: 0, value: 0 }
        ]
      },
      {
        ...
        value: 30,
        holdings: [
          { symbol: "OLD", quantity: 1, close: 20, value: 20 },
          { symbol: "NEW", quantity: 2, close: 5, value: 10 }
        ]
      },
      {
        date: "2022-01-04",
        value: 33,
        holdings: [
          { symbol: "OLD", quantity: 1, close: 21, value: 21 },
          { symbol: "NEW", quantity: 2, close: 6, value: 12 }
        ]
      }
    ]);
  } finally {
