...
const defaultHoldings = [{ id: "holding-1", symbol: "AAPL", quantity: "10" }];
...
const holdingPalette = ["#b85c38", "#f6b73c", "#2f7d6c", "#4763b3", "#b84a62", "#7e5ab6", "#4f8f2f", "#b76b2f"];
...
export default function BacktesterApp() {
  ...
  const activeChange =
    result && activePoint ? Number((activePoint.value - result.summary.startValue).toFixed(2)) : null;
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <p className="eyebrow">Portfolio Backtester</p>
